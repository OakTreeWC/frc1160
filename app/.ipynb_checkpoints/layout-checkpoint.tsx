  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <div>
            <footer className="flex flex-col h-45 relative w-full bg-white text-black content-center justify-center text-center space-y-4">
                <div className="flex flex-row flex-wrap justify-center content-center space-x-7">
                    ...
                    <Link href="mailto:titaniumrobotics@gmail.com" className="w-10 h-15 border-b-2" suppressHydrationWarning >

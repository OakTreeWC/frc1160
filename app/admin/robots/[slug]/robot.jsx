...
export default function Robot({ robot, editRobot, changeThumbnail, addComp, deleteComp, reloadCompetitions, addResource, deleteResource, setPublishedRobot, compData }) {
    ...
    function submitEdits() {
        ...
        let season = seasonRef.current?.innerText;
        if (season === 'Season Name') season = '';
        robot.name=name;
        robot.description=desc;
        robot.seasonname=season;
        editRobot(robot.slug,name,desc, season);
    }
            ...
            <div className="pb-19 px-10 md:px-45 w-full">
                <div className="flex flex-row justify-center flex-wrap">
                    <div className="flex flex-col items-center space-y-10 px-8 text-center">
                        ...
                        <span ref={descRef} contentEditable suppressContentEditableWarning className="text-xl text-center font-light w-[67%]">{robot.description || 'No Description Yet.'}</span>
                    </div>
                </div>
            </div>
                ...
                <div className="flex flex-row justify-center flex-wrap">
                    <div className="flex flex-col items-center space-y-5 px-8">
                        <span className="flex flex-row space-x-7 items-center justify-center">
                            <button onClick={() => reloadCompetitions()} >
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="h-10 w-10 p-2 hover:cursor-pointer hover:fill-white transition hover:bg-blue-500/40 duration-300 ease-out rounded-xl">{/* Font Awesome Free v7.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc. */}<path d="M436.7 74.7L448 85.4 448 32c0-17.7 14.3-32 32-32s32 14.3 32 32l0 128c0 17.7-14.3 32-32 32l-128 0c-17.7 0-32-14.3-32-32s14.3-32 32-32l47.9 0-7.6-7.2c-.2-.2-.4-.4-.6-.6-75-75-196.5-75-271.5 0s-75 196.5 0 271.5 196.5 75 271.5 0c8.2-8.2 15.5-16.9 21.9-26.1 10.1-14.5 30.1-18 44.6-7.9s18 30.1 7.9 44.6c-8.5 12.2-18.2 23.8-29.1 34.7-100 100-262.1 100-362 0S-25 175 75 75c99.9-99.9 261.7-100 361.7-.3z"/></svg>
                            </button>

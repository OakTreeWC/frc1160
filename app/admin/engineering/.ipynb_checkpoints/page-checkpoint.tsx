...
import { getEngineering, createEngineering, removeEngineering } from '@/app/lib/data';
import { revalidatePath } from 'next/cache';

export default async function Page() {
  const sponsors = await getEngineering();
  ...
  async function createCabinet(formData: FormData) {
    ...
    await createEngineering(name, position, grade, years);
